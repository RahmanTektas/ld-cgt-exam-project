...
\title{
	\todo{Achieving Cooperation in a Minimally Constrained Environment}
}
...
\author{Antoine Lefranc}
\affiliation{%
 \institution{Student Number \\ ULB}
} \email{xyz@vub.be}

\author{Victor t'Serstevens}
\affiliation{%
 \institution{513771 \\ ULB}
} \email{victor.tserstevens@ulb.be}
